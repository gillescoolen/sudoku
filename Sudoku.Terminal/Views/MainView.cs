...
namespace Sudoku.Terminal.Views
{
    ...
    {
        public MainView(MainController controller) : base(controller, new Input((int)ConsoleKey.Enter, controller.ChooseType), new Input((int)ConsoleKey.UpArrow, () => controller.MoveSelection(-1)), new Input((int)ConsoleKey.DownArrow, () => controller.MoveSelection(1)))
        {
        }
